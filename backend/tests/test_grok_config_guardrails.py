...
DOCS_TECH_SPEC_PATH = REPO_ROOT / "docs/技术说明-采集策略与AI-Prompt.md"
VERIFY_SCRIPT_PATH = REPO_ROOT / "scripts/verify-critical-paths.sh"
README_DOCS_VERIFY_SCRIPT_PATH = REPO_ROOT / "scripts/verify-readme-docs.sh"
...
EXPECTED_PUBLIC_TEXT_ARTIFACTS = (
    ...
    README_DOCS_VERIFY_SCRIPT_PATH,
    VERIFY_SCRIPT_PATH,
)
