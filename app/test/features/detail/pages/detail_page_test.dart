...
void main() {
  ...
  testWidgets('header title stack stays clear of the back button', (
    ...
    final keywordRect = tester.getRect(
      find.text('MACRO AI SENTIMENT OUTLOOK'),
    );
  ...
  testWidgets('header title stack stays clear in Chinese locale', (tester) async {
    tester.view.physicalSize = const Size(390, 844);
    tester.view.devicePixelRatio = 1;
    addTearDown(tester.view.reset);
    ...
    await tester.pumpWidget(
      _wrap(
        analysisRepository: _FakeAnalysisRepository(task: zhTask, report: report),
        feedRepository: _FakeFeedRepository(posts: const []),
